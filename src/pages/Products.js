    ...
    return (
        <>
            ...
            <div className="container">
                ...
                <div className="Frame427320629" style={{ width: 691, display: 'inline-flex', flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', }}>
                    <div className="CarName" style={{ width: 220, display: 'inline-flex', flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'flex-start', }}>
                        <p className="NissanGT - R" style={{ width: 220, height: 40, fontSize: 31, fontWeight: '600', lineHeight: '100%', color: 'rgba(26, 32, 44, 1)', }}>Nissan GT - R</p>
                        <div style={{ height: 8, }} />
                        <div className="Reviews" style={{ height: 24, display: 'inline-flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', }}>
                            <div className="ReviewStar" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', }}>
                            ...
                            <div style={{ width: 8, }} />
                            <p className="440+Reviewer" style={{ width: 104, height: 20, fontSize: 13, fontWeight: '500', lineHeight: '100%', color: 'rgba(61, 82, 120, 1)', }}>440+ Reviewer</p>
                        </div>
                    </div>
                    <div className="Frame427320631" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', }}>
                        <div className="Frame427320631" style={{ paddingLeft: 10, paddingRight: 10, paddingTop: 3, paddingBottom: 3, backgroundColor: 'rgba(237, 63, 63, 1)', borderRadius: 6, display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', }}>
                            <p className="LIVE" style={{ fontSize: 13, lineHeight: '100%', color: 'rgba(242, 242, 242, 1)', }}>LIVE</p>
                        </div>
                        <div style={{ width: 10, }} />
                        <img className="Heart" style={{ width: 24, height: 24, borderRadius: 8, }} src="https://via.placeholder.com/24x24" />
                    </div>
                </div>
                <div className="Frame427320631" style={{ width: 691, display: 'inline-flex', flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', }}>
                ...
                <div className="Frame427320630" style={{ width: 691, display: 'inline-flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', }}>
